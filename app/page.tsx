      ...
      <div className="max-w-2xl mx-auto px-6 py-16 md:py-24">
        ...
        <section className="mb-12">
          ...
          <div className="flex flex-wrap gap-2">
            {/* JavaScript */}
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-900/50">
              ...
              <span className="text-sm font-medium text-amber-700 dark:text-amber-300">JavaScript</span>
            </div>

            {/* Python */}
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-sky-50 dark:bg-sky-950/40 border border-sky-200 dark:border-sky-900/50">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="text-sky-500">
              ...
              <span className="text-sm font-medium text-sky-700 dark:text-sky-300">Python</span>
            </div>

            {/* SQL */}
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-orange-50 dark:bg-orange-950/40 border border-orange-200 dark:border-orange-900/50">
              ...
              <span className="text-sm font-medium text-orange-700 dark:text-orange-300">SQL</span>
            </div>

            {/* Node.js */}
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-green-50 dark:bg-green-950/40 border border-green-200 dark:border-green-900/50">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="text-green-600 dark:text-green-500">
              ...
              <span className="text-sm font-medium text-green-700 dark:text-green-300">Node.js</span>
            </div>

            {/* Git */}
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-red-50 dark:bg-red-950/40 border border-red-200 dark:border-red-900/50">
              ...
              <span className="text-sm font-medium text-red-700 dark:text-red-300">Git</span>
            </div>

            {/* React */}
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-cyan-50 dark:bg-cyan-950/40 border border-cyan-200 dark:border-cyan-900/50">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="text-cyan-500">
              ...
              <span className="text-sm font-medium text-cyan-700 dark:text-cyan-300">React</span>
            </div>
          </div>
        </section>
